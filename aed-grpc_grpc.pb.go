...
func (c *aEDServiceClient) Upsert(ctx context.Context, in *AED, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, AEDService_Upsert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aEDServiceClient) BatchUpsert(ctx context.Context, in *AEDs, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AEDService_BatchUpsert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aEDServiceClient) Get(ctx context.Context, in *AEDFilter, opts ...grpc.CallOption) (*AEDs, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AEDs)
	err := c.cc.Invoke(ctx, AEDService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aEDServiceClient) GetAEDsForPeriods(ctx context.Context, in *PeriodsFilter, opts ...grpc.CallOption) (*AEDs, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AEDs)
	err := c.cc.Invoke(ctx, AEDService_GetAEDsForPeriods_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aEDServiceClient) GetForPeriodAndTimestamp(ctx context.Context, in *GetForPeriodAndTimestampRequest, opts ...grpc.CallOption) (*AED, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AED)
	err := c.cc.Invoke(ctx, AEDService_GetForPeriodAndTimestamp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAEDServiceServer should be embedded to have
...
func (UnimplementedAEDServiceServer) GetAEDsForPeriods(context.Context, *PeriodsFilter) (*AEDs, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAEDsForPeriods not implemented")
}
func (UnimplementedAEDServiceServer) GetForPeriodAndTimestamp(context.Context, *GetForPeriodAndTimestampRequest) (*AED, error) {
	return nil, status.Error(codes.Unimplemented, "method GetForPeriodAndTimestamp not implemented")
}
func (UnimplementedAEDServiceServer) testEmbeddedByValue() {}
...
func RegisterAEDServiceServer(s grpc.ServiceRegistrar, srv AEDServiceServer) {
	// If the following call panics, it indicates UnimplementedAEDServiceServer was
...
func _AEDService_Upsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AEDService_Upsert_FullMethodName,
	}
...
func _AEDService_BatchUpsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AEDService_BatchUpsert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AEDService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AEDService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
